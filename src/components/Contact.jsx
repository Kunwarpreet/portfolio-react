                ...
                <div className='flex flex-col md:flex-row gap-12 mt-5'>
                    ...
                    <div className='flex flex-col md:flex-row items-center justify-center mt-7 gap-4'>
                        ...
                        <div>
                            ...
                            <a href='mailto:singhkunwarpreet797' className='text-center md:text-left   duration-300 hover:text-[color:var(--primary-color)] font-para' target='_blank' rel="noreferrer">singhkunwarpreet797@gmail.com</a>
                        </div>
                    </div>
                </div>
        ...
        <div className='bg-[color:var(--navbar-link-color)] py-16 px-10 text-white rounded-2xl'>
            <div className='container mx-auto flex flex-col md:flex-row justify-between'>
                ...
                <div className='flex gap-3 items-center justify-center mt-4 md:mt-0'>
                    <a href='https://www.linkedin.com/in/kunwarpreet-singh-390456196/' target='_blank' rel="noreferrer">
                        <FaLinkedin fontSize={25} className='duration-500 hover:text-[color:var(--primary-color)] font-bold'/></a>
                    
                    <a href="https://github.com/Kunwarpreet" target='_blank' rel="noreferrer" ><FaGithub fontSize={25} className='font-bold hover:text-[color:var(--primary-color)]'/></a>
                </div>
